...
export function setupHeader(pageName) {
  ...
  switch (pageName) {
    case "water":
      document.querySelector("#water").src =
        "assets/img/round_icons/vanduo_yelow.png";
      break;
    case "farm":
      document.querySelector("#open-farm").src =
        "assets/img/round_icons/ukis_yelow.png";
      break;
    case "food":
      document.querySelector("#natural-food").src =
        "assets/img/round_icons/produktai_yelow.png";
      break;
    case "wine":
      document.querySelector("#wine").src =
        "assets/img/round_icons/vynas_yelow.png";
      break;
    case "shoping areas":
      document.querySelector("#shop-areas").src =
        "assets/img/round_icons/krautuves_yelow.png";
      break;
    case "principles":
      document.querySelector("#principles").src =
        "assets/img/round_icons/principai1_yelow.png";
      break;
    case "farm_map":
